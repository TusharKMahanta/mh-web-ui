...
export default function CalanderA() {
  return (
    <>
      <div className="grid grid-cols-2 gap-x-6 gap-y-10 sm:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 xl:gap-x-8 px-10 content-start text-center">
      {days.map((day) => (
       <div className="bg-gray-100 rounded-s-lg rounded-e-lg" key={day.date}>
         {day.date}
        </div>
      ))}
      </div>
